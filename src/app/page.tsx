...
import { CurrencyExchangeApp } from '@/features/currency-exchange'
...
export default function Home() {
	return (
		<Tabs defaultValue={0} className='flex min-h-screen flex-col gap-0'>
			<TabsList
				variant='line'
				className='w-full h-10 justify-start overflow-x-auto border-b px-4 py-1'
			>
				...
				<TabsTrigger value={2} className='flex-none px-3 text-lg'>
